...
public class ImplLoginServiceLocator extends org.apache.axis.client.Service implements com.b7f2.ws.service.ImplLoginService {
    ...
    private java.lang.String ImplLogin_address = "https://www.czidconnect.es:8443/messenger/services/ImplLogin";
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.ws.b7f2.com", "ImplLoginService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.ws.b7f2.com", "ImplLogin"));
        }
